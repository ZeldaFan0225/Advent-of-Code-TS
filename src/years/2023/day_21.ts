...
export function part_2(input: string[]): number {
    const { start, plot } = parsePlot(input);
...
/*
==============================
The code below has not been written by me.
The code is from https://github.com/ckohen/adventofcode/blob/main/archive/2023/Day21.ts
from the repository https://github.com/ckohen/adventofcode
The code has not been modified in any way.

A copy of the original License can be found at the end of the file
==============================
 */
